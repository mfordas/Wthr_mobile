...
class Location extends React.Component {
    ...
    try {
      const granted = await PermissionsAndroid.request(
        PermissionsAndroid.PERMISSIONS.ACCESS_FINE_LOCATION,
        {
          ...
          message: 'Wthr App needs access to your location ',
  ...
  showCityName = () => {
    return this.props.cityData.cityData.city
      ? this.props.cityData.cityData.city
      : 'City not found';
  };

  showCityCountry = () => {
    return this.props.cityData.cityData.prov
      ? this.props.cityData.cityData.prov
      : 'try again';
  };
