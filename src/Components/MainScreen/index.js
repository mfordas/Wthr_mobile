...
import { View, Text, TouchableOpacity, Linking, Image, ScrollView, Button } from 'react-native';
  ...
  render() {
    return (
        ...
        <View style={mainStyling.weatherContainer}>
          ...
          <Text style={mainStyling.conditionsText}>{changeMetersPerSecondToKMetersPerHour(this.props.weatherData.weatherData.current.wind_speed)} km/h</Text>
          </View>
          <View style={mainStyling.conditionsContainer}>
    ...
    <Text style={mainStyling.conditionsText}>{this.props.weatherData.weatherData.current.humidity}%</Text>
          ...
          <Image style={mainStyling.mainWeatherIcon} source={chooseIcon(this.props.weatherData.weatherData.current.weather[0].icon)} />
        </View>
        <Button
